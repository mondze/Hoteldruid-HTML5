...
case "senza mostrare il valore":  		$messaggio = "without showing the value"; break;
case "mostrando il valore":  			$messaggio = "showing the value"; break;
case "senza mostrare i valori":  		$messaggio = "without showing the values"; break;
case "mostrando i valori":  			$messaggio = "showing the values"; break;
case "Possibilità di modificare l'utente che ha inserito":	$messaggio = "Possibility to modify the inserting user"; break;
case "con tutti gli utenti":  			$messaggio = "with all users"; break;
case "solo con utenti dei suoi gruppi":  	$messaggio = "only with users from his groups"; break;
case "mostrando l'utente":  			$messaggio = "showing the user"; break;
case "senza mostrare l'utente":  		$messaggio = "without showing the user"; break;
case "potrà modificare l'<b>utente</b> che ha inserito la prenotazione nel":	$messaggio = "will be able to modify the <b>user</b> that inserted the reservation in"; break;
case "non potrà modificare l'<b>utente</b> che ha inserito la prenotazione nel":	$messaggio = "will not be able to modify the <b>user</b> that inserted the reservation in"; break;
case "senza mostrarla":  			$messaggio = "without showing it"; break;
case "senza mostrarli":  			$messaggio = "without showing them"; break;
case "Modifica delle tipologie di persone":  	$messaggio = "Modify people types"; break;
case "potrà modificare le sue <b>tipologie di persone</b>":	$messaggio = "will be able to modify his <b>people types</b>"; break;
case "non potrà più modificare le sue <b>tipologie di persone</b>":	$messaggio = "will not be able to modify his <b>people types</b>"; break;
